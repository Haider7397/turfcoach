    ...
    return (
        <div className="favourite-table">
            <div className="container">
                <h1 className="favourite-title">Faviourite Cities</h1>
                {
                                    ...
                                    city.weather.map((item, ind) => {
                                        return ind === 0 ? <div key={ind}>
                                            ...
                                            <div className="favourite-content">
                                                <div className="location">{city.name} <span><svg xmlns="http://www.w3.org/2000/svg" fill={city.favourite ? "#865305" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke={city.favourite ? "#865305" : "currentColor"} className="forecast-fav" onClick={() => onRemoveFavourite$.next(city.id)}>
